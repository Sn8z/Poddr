...
let reactCra = exports.reactCra = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (projectDir) {
        if ((yield (0, (_fs || _load_fs()).statOrNull)(_path.join(projectDir, "public", "electron.js"))) == null) {
            ...
            (_builderUtil || _load_builderUtil()).log.warn("public/electron.js not found. Please see https://medium.com/@kitze/%EF%B8%8F-from-react-to-an-electron-app-ready-for-production-a0468ecb1da3");
        }
        return {
            directories: {
