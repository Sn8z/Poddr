...
for dir in $SNAPCRAFT_PART_INSTALL/usr/share/icons/*/; do
  ...
  build(appOutDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const args = ["snap", "--app", appOutDir, "--stage", stageDir, "--arch", (0, _builderUtil().toLinuxArchString)(arch), "--output", artifactPath, "--docker-image", (0, _Framework().isElectronBased)(_this.packager.info.framework) && _this.packager.isElectron2 ? "electronuserland/snapcraft-electron:2" : "electronuserland/builder:latest"];
