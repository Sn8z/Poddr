...
class PlatformPackager {
    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield _this2.beforeCopyExtraFiles(appOutDir, asarOptions == null ? null : yield (0, (_asarIntegrity || _load_asarIntegrity()).computeData)(resourcesPath, asarOptions.externalAllowed ? { externalAllowed: true } : null));
