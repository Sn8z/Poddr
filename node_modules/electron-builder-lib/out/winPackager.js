  ...
  signApp(packContext) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      if (_this5.platformSpecificBuildOptions.signAndEditExecutable !== false) {
        yield _this5.signAndEditResources(path.join(packContext.appOutDir, exeFileName), packContext.arch, packContext.outDir, path.basename(exeFileName, ".exe"), _this5.platformSpecificBuildOptions.requestedExecutionLevel);
      }
    })();
  }
