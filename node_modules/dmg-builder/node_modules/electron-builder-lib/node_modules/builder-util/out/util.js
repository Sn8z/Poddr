...
function doSpawn(command, args, options, extraOptions) {
  ...
  if (options.stdio == null) {
    const isDebugEnabled = extraOptions == null || extraOptions.isDebugEnabled == null ? _log().debug.enabled : extraOptions.isDebugEnabled; // do not ignore stdout/stderr if not debug, because in this case we will read into buffer and print on error
