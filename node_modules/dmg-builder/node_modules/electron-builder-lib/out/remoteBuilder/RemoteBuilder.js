...
class RemoteBuilder {
  ...
  async _build(targets, packager) {
    ...
    for (let attempt = 0; true; attempt++) {
      const endpoint = await findBuildAgent(); // for now assume that all targets has the same outDir (correct for Linux)
...
async function findBuildAgent() {
  ...
  return await new (_bluebirdLst().default)((resolve, reject) => {
