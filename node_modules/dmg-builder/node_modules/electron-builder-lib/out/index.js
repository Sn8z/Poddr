...
async function build(options, packager = new (_packager().Packager)(options)) {
  ...
  return await (0, _promise().executeFinally)(packager.build().then(() => Array.from(artifactPaths)), errorOccurred => {
    let promise;
