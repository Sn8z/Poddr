...
class WebInstallerTarget extends _NsisTarget().NsisTarget {
  ...
  async configureDefines(oneClick, defines) {
    ...
    if (appPackageUrl == null) {
      const publishConfigs = await (0, _PublishManager().getPublishConfigsForUpdateInfo)(packager, (await (0, _PublishManager().getPublishConfigs)(packager, this.options, null, false)), null);
