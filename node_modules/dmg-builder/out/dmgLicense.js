...
let addLicenseToDmg = exports.addLicenseToDmg = (() => {
  ...
  $"0000 0000 0000"
            ...
            data += isRtf ? serializeString(Buffer.from(fileData).toString("hex")) : wrapInRtf((yield (0, (_fsExtraP || _load_fsExtraP()).readFile)(item.file, "utf-8")));
            data += "\n};";
            rtfs.push(data);
            defaultButtons.push((0, (_licenseDefaultButtons || _load_licenseDefaultButtons()).getDefaultButtons)(item.langWithRegion, counter, item.langName));
