...
export class PlayerComponent implements OnInit {
  ...
  public volumeSlider: HTMLElement;
  ...
  public rss: string;
  public playbackRates: number[] = [2.0, 1.75, 1.5, 1.25, 1.0, 0.75, 0.5, 0.25];
  ...
  ngOnInit(): void {
    this.audio.loading.subscribe((value) => {
      this.isLoading = value;
    });
    this.audio.playing.subscribe((value) => {
      this.isPlaying = value;
    });
    this.audio.muted.subscribe((value) => {
      this.isMuted = value;
    });
    this.audio.volume.subscribe((value) => {
      this.volume = Math.sqrt(value);
    });
    this.audio.percentPlayed.subscribe((value) => {
      this.percentPlayed = value;
    });
    this.audio.time.subscribe((value) => {
      this.time = value;
    });
    this.audio.duration.subscribe((value) => {
      this.duration = value;
    });
    this.audio.episode.subscribe((value) => {
      this.episode = value;
    });
    this.audio.podcast.subscribe((value) => {
      this.podcast = value;
    });
    this.audio.description.subscribe((value) => {
      this.description = value;
    });
    this.audio.rss.subscribe((value) => {
      this.rss = value;
    });
    this.audio.playbackRate.subscribe((value) => {
  ...
  showDescription(): void {
    this.toast.modal(
      "Podcast description",
      this.descriptionPipe.transform(this.description)
    );
  }
